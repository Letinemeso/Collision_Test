//#ifndef __SPACE_SPLITTER_3D
//#define __SPACE_SPLITTER_3D
...
//	private:
//		static void split_space_recursive(LEti::Tree<Area, 8>::Iterator _it, unsigned int _level);
//	public:
//		static void update();
