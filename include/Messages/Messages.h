...
namespace Shardis
{
    ...
    MESSAGE_TYPE_DECLARATION_START(Message__On_Entity_Healed)
    LEti::Object* healed_entity = nullptr;
    float health_before = 0.0f;
    float health_after = 0.0f;
    MESSAGE_TYPE_DECLARATION_END

    MESSAGE_TYPE_DECLARATION_START(Message__On_Natural_Entity_Death)
    LEti::Object* almost_dead_entity = nullptr;
    MESSAGE_TYPE_DECLARATION_END
    ...
    MESSAGE_TYPE_DECLARATION_START(Message__Pause_Game)
    bool pause = false;
    MESSAGE_TYPE_DECLARATION_END
