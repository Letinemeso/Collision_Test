...
namespace Shardis
{
    ...
    class On_Death_Effect_Module : public LEti::Module
    {
    public:
        INIT_VARIABLE(Shardis::On_Death_Effect_Module, LEti::Module)
    ...
    class On_Death_Effect_Module_Stub : public LEti::Module_Stub
    {
    public:
        INIT_VARIABLE(Shardis::On_Death_Effect_Module_Stub, LEti::Module_Stub)
    ...
    public:
        INIT_BUILDER_STUB(On_Death_Effect_Module)

    public:
        ~On_Death_Effect_Module_Stub();
